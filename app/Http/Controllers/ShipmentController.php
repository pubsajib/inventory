...
class ShipmentController extends Controller
{
    ...
    public function index()
    {
        ...
        /////123456///////////
        foreach ($data['shipmentList'] as $item) {
            ...
            $item->total_shipment = $item->total_shipment - $item_total_returned;
        }
        /////123456///////////
...
//print "<pre>";print_r($data);exit;
        /////123456///////////
        $reference = $data['orderInfo']->reference;
        $raw_all_order_no = DB::table('sales_orders')->select('order_no')->where('order_reference',$reference)->get();
        $all_order_no = array_column($raw_all_order_no, 'order_no');
        ...
        $data['shipmentItem'][0]->quantity = $data['shipmentItem'][0]->quantity - $item_total_returned;
