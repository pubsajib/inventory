...
class Purchase extends Model
{
    ...
    { 
        return $this->leftJoin('suppliers', 'purch_orders.supplier_id', '=', 'suppliers.supplier_id')
                    ->leftJoin('purch_order_details', 'purch_orders.order_no', '=', 'purch_order_details.order_no')
                    ->leftJoin('item_code', 'purch_order_details.item_code', '=', 'item_code.id')
                    ...
                    ->select('purch_orders.*', 'suppliers.supp_name','location.location_name as loc_name','stock_master.description as item_title')
