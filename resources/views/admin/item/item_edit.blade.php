                            ...
                            <div class="col-md-6">
                                ...
                                <form action="{{ url('update-item-info') }}" method="post" id="itemEditForm" class="form-horizontal" enctype="multipart/form-data">
                                    ...
                                    <div class="box-body">
                                        ...
                                        <div class="form-group">
                                            <label class="col-sm-3 control-label" for="inputEmail3">Country of Origin</label>

                                            <div class="col-sm-9">
                                                <select class="form-control select2" name="item_country_id" id="ship_country_id">
                                                    <option value="">{{ trans('message.form.select_one') }}</option>
                                                    @foreach ($countries as $data)
                                                        <option value="{{$data->code}}" <?= ($itemInfo->item_country_id==$data->code)?'selected':''?>>{{$data->country}}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                        </div>
