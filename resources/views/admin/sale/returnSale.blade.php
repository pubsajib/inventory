            ...
            <div class="col-md-12">
                <div class="box box-default">
                    ...
                    <div class="box-body">
                        ...
                        <form action="{{url('sales/reduceReturnedSale')}}" method="POST" id="salesForm">
                            <input type="hidden" value="{{csrf_token()}}" name="_token" id="token">
                            <input type="hidden" value="{{$saleData->order_no}}" name="order_no" id="order_no">
                            <input type="hidden" value="{{$saleData->paid_amount}}" name="paid_amount" id="paid_amount">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control select2" name="payment_term" disabled>
                                                ...
                                                @if(count($invoiceData)>0)
                                                    @foreach($invoiceData as $result)
                                                        <tr class="nr" data-tax_type="{{$result->tax_rate}}" id="rowid{{$result->item_id}}">
                                                            ...
                                                            <td>
                                                                <input class="form-control text-center no_units" stock-id="{{$result->stock_id}}" min="1" max="{{$result->quantity}}" data-id="{{$result->item_id}}" data-rate="{{$result->tax_rate}}" id="qty_{{$result->item_id}}" name="item_quantity[]" value="{{$result->quantity}}" data-tax="{{$result->tax_rate}}" type="text" required autocomplete="off">
