...
<div class="box-body">
              ...
              <div class="col-md-12">
                ...
                <div class="form-group">
                  <label class="col-sm-3 control-label " for="inputEmail3">{{ trans('message.extra_text.street') }}</label>
                  <div class="col-sm-6">
                ...
                <div class="form-group">
                  <label class="col-sm-3 control-label " for="inputEmail3">{{ trans('message.extra_text.city') }}</label>
                  <div class="col-sm-6">
                ...
                <div class="form-group">
                  <label class="col-sm-3 control-label " for="inputEmail3">{{ trans('message.extra_text.country') }}</label>
                  <div class="col-sm-6">
