      ...
      <ul class="sidebar-menu">
        ...
        <li <?= $menu == 'item' ? ' class="active"' : ''?> >
          <a href="{{url('item')}}">
            ...
            <span>{{-- trans('message.sidebar.item') --}} Items</span>
          </a>
        </li>
        ...
        <li <?= $menu == 'report' ? ' class="treeview active"' : 'treeview'?> >
          ...
          <ul class="treeview-menu">
            ...
            <li <?=isset($sub_menu) && $sub_menu == 'customer-ranking' ? ' class="active"' : ''?> >
              <a href="{{url('report/customer-ranking')}}">
                <span>Customer Ranking</span>
              </a>
            </li>

            <li <?=isset($sub_menu) && $sub_menu == 'product-ranking' ? ' class="active"' : ''?> >
              <a href="{{url('report/product-ranking')}}">
                <span>Product Ranking Report</span>
              </a>
            </li>
            ...
            <li <?=isset($sub_menu) && $sub_menu == 'customer-ledger' ? ' class="active"' : ''?> >
              <a href="{{url('report/customer-ledger')}}">
